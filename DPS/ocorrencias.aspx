<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ocorrencias.aspx.cs" Inherits="DPS.ocorrencias" %>
...
<body>
    <form id="form1" runat="server" class="form-horizontal">
        ...
        <asp:Timer runat="server" ID="timer1" Interval="5000" Enabled="true" OnTick="timer1_Tick">
            ...
            <div class="row">
                <div class="page-header">
                    <h1><%=Session["tipoAcao"].ToString() %> <small>de Ocorrências</small></h1>
                </div>
                <!--INICIO DA CONSULTA-->
                <div id="divconsulta" runat="server" visible="true">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="form-group col-sm-4">
                                <span class="col-sm-6 control-label">Nome Cliente</span>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtFiltroNomeCliente" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group col-sm-4">
                                <span class="col-sm-6 control-label">Nome Funcionário</span>
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtFiltroNomeFuncionario" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group col-sm-4">
                                <span class="col-sm-6 control-label">Data</span>
                                <div class="col-sm-6">
                    ...
                    <br />
                    <asp:GridView ID="grid" Font-Size="8" CssClass="table table-hover" OnRowDataBound="grid_RowDataBound" AutoGenerateColumns="false" runat="server" OnRowCommand="grid_RowCommand">
                        <Columns>
                            <asp:BoundField HeaderText="Situação" />
                            <asp:BoundField DataField="nome_cliente" HeaderText="Cliente" />
                            <asp:BoundField DataField="nome_funcionario" HeaderText="Funcionário" />
                            <asp:BoundField DataField="datahora" HeaderText="Última Edição" />
                            <asp:BoundField DataField="historico" HeaderText="Histórico" />
                            <asp:ButtonField ButtonType="Link" CommandName="Editar" ControlStyle-CssClass="btn btn-warning btn-xs" Text="Editar" />
                        </Columns>
                    </asp:GridView>
                </div>
                ...
                <div id="divalteracao" runat="server">
                    <div class="panel panel-primary class">
                        <div class="panel-heading">Pesquisar Cliente:</div>
                        <br />
                        <div class="form-group">
                            <span class="col-sm-2 text-center">CPF:</span>
                            <div class="col-sm-2">
                                <asp:TextBox ID="txtCPFCliente" CssClass="form-control padraoCpf" Enabled="false" runat="server"></asp:TextBox>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <asp:LinkButton runat="server" ID="lnkBuscaCliente" CssClass="btn btn-primary" OnClick="lnkBuscaCliente_Click">
                                    <span class="glyphicon glyphicon-search"></span>
                                    Busca
                                </asp:LinkButton>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 text-center" style="text-align: center; margin-left: 10%">
                                <asp:GridView ID="grdBuscaCliente" Font-Size="8" CssClass="table table-hover" AutoGenerateColumns="false" runat="server" OnRowCommand="grdBuscaCliente_RowCommand">
                                    <Columns>
                    ...
                    <div class="panel panel-primary class">
                        ...
                        <div class="form-group">
                            <span class="col-sm-2 text-center">CPF:</span>
                            <div class="col-sm-2">
                                <asp:TextBox ID="txtCPFFunc" CssClass="form-control padraoCpf" Enabled="false" runat="server"></asp:TextBox>
                            </div>
                            <span class="col-sm-2 text-center">Nome:</span>
                            <div class="col-sm-3">
                                <asp:TextBox ID="txtNomeBuscarFunc" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-sm-2">
                                <asp:LinkButton runat="server" ID="lnkBuscarFunc" CssClass="btn btn-primary" OnClick="lnkBuscarFunc_Click">
                                    <span class="glyphicon glyphicon-search"></span>
                                    Busca
                                </asp:LinkButton>
                            </div>
                    ...
                    <br />
                    <div class="panel panel-primary class">
                        <div class="panel-heading">Dados de Localização e Histórico</div>
                        <br />
                         <div class="form-group">
                            <span class="col-sm-2 text-center">Histórico:</span>
                            <div class="col-sm-8">
                                <asp:TextBox runat="server" ID="txtHistórico" TextMode="MultiLine" Rows="5" CssClass="form-control text-uppercase"></asp:TextBox>
                            </div>
                             </div>
                        <br />
                        <div class="form-group">
